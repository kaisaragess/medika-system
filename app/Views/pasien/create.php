...
<div class="row">
    <div class="col-md-8 mx-auto">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <!-- Form mengarah ke PasienController method store -->
                <form action="/pasien/store" method="post">
                    <!-- Fitur keamanan CI4 untuk mencegah serangan CSRF -->
                    <?= csrf_field(); ?>

                    <div class="mb-3">
                        <label for="nik" class="form-label">NIK</label>
                        <input type="text" class="form-control <?= ($validation->hasError('nik')) ? 'is-invalid' : ''; ?>" id="nik" name="nik" value="<?= old('nik'); ?>" autofocus>
